...
Home:CreateButton({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            local homePart = workspace:FindFirstChild("MainTrees") 
                and workspace.MainTrees:FindFirstChild(LocalPlayer.Name)
                and workspace.MainTrees[LocalPlayer.Name]:FindFirstChild("LET_THERE_BE_LIGHT")
            if homePart then
...
Home:CreateButton({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            local shopPart = workspace:FindFirstChild("Main Map Assets")
                and workspace["Main Map Assets"]:FindFirstChild("Center Details & etc")
                and workspace["Main Map Assets"]["Center Details & etc"]:FindFirstChild("Center Home")
                and workspace["Main Map Assets"]["Center Details & etc"]["Center Home"]:FindFirstChild("Union")
            if shopPart then
...
local FruitDropdown = Fruits:CreateDropdown({
   Name = "Fruit",
...
local CrystalDropdown = Crystals:CreateDropdown({
   Name = "Crystals",
...
local SpawnFruitDropdown = Spawn:CreateDropdown({
   Name = "Fruit",
   Options = fruitOptions,
   CurrentOption = {"Apple (2 Silver)"},
   MultipleOptions = false,
...
Spawn:CreateButton({
   ...
   Callback = function()
      ...
      if selected and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
         ...
         fruit:SetPrimaryPartCFrame(CFrame.new(LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 5, 0)))
...
local SpawnCrystalDropdown = Spawn:CreateDropdown({
   Name = "Crystal",
   Options = {"Blue Crystal", "Purple Crystal", "Red Crystal", "Orange Crystal", "Green Crystal"},
   CurrentOption = {"Blue Crystal"},
   MultipleOptions = false,
...
Spawn:CreateButton({
   ...
   Callback = function()
      ...
      if selected and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
         ...
         crystal:SetPrimaryPartCFrame(CFrame.new(LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 5, 0)))
   ...
   Spawn:CreateButton({
      ...
      Callback = function()
         if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            ...
            model:SetPrimaryPartCFrame(CFrame.new(LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 5, 0)))
...
local TeleportDropdown = More:CreateDropdown({
   Name = "Player",
